...
+ Аллегрова   <img src="P1470941 копия.jpg" alt="Описание изображения" title="Подсказка при наведении" align="right" width="250px"  style="opacity: 0.4;">
...
+ Ассорти 
+ Арианна
+ Арбенина Д.<img src="pngwing.com (1).png" alt="Описание изображения" title="Подсказка при наведении" align="right" width="250px" style= "opacity: 0.6;">
+ Анка 
+ Альфа (Сарычев) Одна Песня Зеркало Река 
+ Ани Лорак 
+ Ария 
+ Август (Каракум) <img src="P1470096-1 копия.jpg" alt="Описание изображения" title="Подсказка при наведении" align="right" width="250px" style= "opacity: 0.4;">
+ Пугачева
+ Орбакайте
+ Арбенина Д.
+ Джанни Стелла 
...
+ Доминик Джокер (Если Ты Со Мной) <img src="P1470961 копия3.jpg" alt="Описание изображения" title="Подсказка при наведении" align="right" width="250px" style= "opacity: 0.3;">
+ Добровольская (Одна)
+ Огонёк
+ Орлова
+ Буланова
...
+ Белоусова (Вечерок)
+ Блестящие
+ Брегвадзе Н. (Снегопад)<img src="pngwing.com.png" alt="Описание изображения" title="Подсказка при наведении" align="right" width="250px" style= "opacity: 0.6;">
+ Брежнева 
...
+ Ваенга Е.<img src="P1470163-1 копия.jpg" alt="Описание изображения" title="Подсказка при наведении" align="right" width="250px" style= "opacity: 0.3;">
+ Верасы (Малиновка)
+ Волга - Волга 
...
+ Глюкоза (Возьми Меня За Руку)<img src="P1470517 копия.jpg" alt="Описание изображения" title="Подсказка при наведении" align="right" width="250px" style= "opacity: 0.3;">
+ Гурцкая (Мама)
...
+ Комбинация
+ Кучин (Человек В Телегрейке)     <img src="0017.gif" alt="Описание изображения" title="Подсказка при наведении" align="right" width="250px" style= "opacity: 0.2;">
+ Королёв (Мурка)
...
+ Френдлих А. (У Природы Нет Плохой Погоды)<img src="pngwing.com.png" alt="Описание изображения" title="Подсказка при наведении" align="right" width="250px" style= "opacity: 0.4;">
