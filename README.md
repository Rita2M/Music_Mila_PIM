...
<style>
  body {
    color: #FFFFFF; /* Здесь можно указать желаемый цвет текста */
  }
</style>
...
+ Глюкоза (Возьми Меня За Руку)<img src="P1470517 копия.jpg" alt="Описание изображения" title="Может споём?" align="right" width="400px" height="auto" style= "opacity: 0.3;">
+ Гурцкая (Мама)
